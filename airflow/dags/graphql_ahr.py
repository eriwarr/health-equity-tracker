...
graphql_ahr_bq_operator_age_state = util.create_bq_ingest_operator(
    'graphql_ahr_to_bq_age_state', graphql_ahr_bq_payload_age_national, data_ingestion_dag
)
...
graphql_ahr_bq_operator_race_state = util.create_bq_ingest_operator(
    'graphql_ahr_to_bq_race_state', graphql_ahr_bq_payload_race_national, data_ingestion_dag
)
...
graphql_ahr_bq_operator_sex_state = util.create_bq_ingest_operator(
    'graphql_ahr_to_bq_sex_state', graphql_ahr_bq_payload_sex_national, data_ingestion_dag
)
